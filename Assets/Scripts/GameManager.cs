...
public class GameManager : MonoBehaviour
{
    ...
    private void Update()
    {
        switch (currentState)
        {
            ...
            default:
                Debug.LogWarning("NOT EXISTING STATE");
                break;
    ...
    public void AssignChosenWeaponsAndPassiveItemsUI(List<Image> chosenWeaponData, List<Image> chosenPassiveItemsData)
    {
        ...
        {
            Debug.Log("Chosen weapons and items data lists has different lenghts");
            return;
        }
